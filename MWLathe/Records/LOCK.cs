...
namespace MWLathe.Records
{
    public class LOCK : Record
    {
        ...
        public UsableData LKDT { get; set; } = new UsableData();
            ...
            while (bytesRead < RecordSize)
            {
                ...
                switch (fieldType)
                {
                    ...
                    case "LKDT":
                        ...
                        LKDT.Weight = BitConverter.ToSingle(buffer);
                        LKDT.Value = BitConverter.ToUInt32(buffer, 4);
                        LKDT.Quality = BitConverter.ToSingle(buffer, 8);
                        LKDT.Uses = BitConverter.ToUInt32(buffer, 12);
                        break;
                    case "SCRI":
                        SCRI = ReadZString(bs);
                    ...
                    case "ITEX":
                        ...
                        break;
                    default:
                        throw new Exception($"Unknown LOCK field \"{fieldType}\"");
                }
            }
        }
